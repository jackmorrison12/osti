  ...
  return (
    <div>
      ...
      <div className="container mx-auto text-center">
        <h1 className="text-6xl m-12">Osti Terms & Conditions</h1>
      </div>
      ...
      <div className="container mx-auto pt-5">
        ...
        <p>
          ...
          use of Osti's Website, located at https://osti.uk.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Osti if you do not agree to take
        ...
        <p>
          We employ the use of cookies. By accessing Osti, you agreed to use
          cookies in agreement with the Osti's Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Osti and/or its licensors own the
          intellectual property rights for all material on Osti. All
          intellectual property rights are reserved. You may access this from
          Osti for your own personal use subjected to restrictions set in these
          terms and conditions.
        </p>

        <p>You must not:</p>
        <ul className="list-disc list-inside p-5">
          <li>Republish material from Osti</li>
          <li>Sell, rent or sub-license material from Osti</li>
          <li>Reproduce, duplicate or copy material from Osti</li>
          <li>Redistribute content from Osti</li>
        </ul>
        ...
        <p>
          ...
          Osti does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of Osti,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, Osti shall not be liable for
        ...
        <p>
          Osti reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Osti a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of Osti; and (d) the link is in
        ...
        <p>
          ...
          sending an e-mail to Osti. Please include your name, your organization
        ...
        <p>
          No use of Osti's logo or other artwork will be allowed for linking
