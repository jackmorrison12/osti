  ...
  return (
    <div>
      ...
      <div className="container mx-auto text-center">
        <h1 className="text-6xl m-12">Osti Private Policy</h1>
      </div>
      ...
      <div className="container mx-auto pt-5">
        ...
        <ul className="list-disc list-inside p-5">
          ...
          <li>
            <strong>Website</strong> refers to Osti, accessible from{" "}
            <a
              href="https://osti.uk"
        ...
        <ul className="list-disc list-inside p-5">
          <li>By email: jack1morrison@sky.com</li>
        </ul>
      </div>
    </div>
  );
